...
/** Supabase implicit row cap — use .range() or .limit() to override */
export const SUPABASE_MAX_ROWS = 1_000;
...
export const FEEDBACK_COPIED_MS = 2_000;
/** Success/info toast auto-dismiss */
export const FEEDBACK_TOAST_MS = 3_000;
...
/** Free shipping threshold in SAR */
export const FREE_SHIPPING_THRESHOLD = 500;
/** Default currency code */
export const DEFAULT_CURRENCY = "SAR";

// ── Boot / PWA ───────────────────────────────────────────────────────
/** App boot watchdog timeout (ms) — must match index.html */
