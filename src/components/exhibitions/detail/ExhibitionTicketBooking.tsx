      ...
      <Card className="overflow-hidden border-chart-3/20 shadow-lg">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{isAr ? "جاهز للدخول" : "Ready for entry"}</p>
              </div>
            </div>
            <Badge className="bg-chart-3/15 text-chart-3 border-chart-3/25 font-semibold text-xs uppercase tracking-wider">
        ...
        <CardContent className="p-4 space-y-4">
          <div className="rounded-xl border border-border/50 bg-muted/30 p-3">
            <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">{isAr ? "رقم التذكرة" : "Ticket Number"}</p>
      ...
      <CardContent className="p-0">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-muted-foreground mt-0.5">{isAr ? "احصل على رمز QR للدخول السريع" : "Get a QR code for quick entry"}</p>
          </div>
