    ...
    <div className="space-y-5">
      ...
      <ScrollArea className="w-full">
        <div className="flex gap-1.5 pb-2">
          ...
          >
            {isAr ? "الكل" : "All"}
            <Badge variant="secondary" className="ms-1.5 h-4 min-w-4 rounded-full px-1 text-xs">{booths.length}</Badge>
          </Button>
          {categories.map((cat) => {
              ...
              <div className="flex items-start gap-3.5">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    <Badge variant="outline" className="font-mono text-xs shrink-0 rounded-md h-5 px-1.5 border-border/60">
                      <Hash className="me-0.5 h-2.5 w-2.5 text-muted-foreground/50" />
                      {booth.booth_number}
                    </Badge>
                    {booth.is_featured && (
                      <Badge variant="outline" className="text-xs h-4 px-1.5 border-chart-4/30 text-chart-4 gap-0.5">
