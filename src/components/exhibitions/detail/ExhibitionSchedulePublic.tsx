  ...
  const { data: items = [], isLoading } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase
        ...
        .select("id, title, title_ar, description, description_ar, start_time, end_time, location, location_ar, category, speaker_name, speaker_name_ar, max_attendees, current_attendees, is_featured")
