        ...
        <CardContent className="p-5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <Badge variant="outline" className={`text-xs mt-0.5 ${statusConfig.color}`}>
                {statusConfig.label}
              </Badge>
            </div>
          </div>
          ...
          {existingRequest.admin_notes && (
            <div className="mt-3 rounded-xl bg-muted/50 p-3">
              <p className="text-xs font-medium text-muted-foreground mb-1">{t("Organizer notes:", "ملاحظات المنظم:")}</p>
      ...
      <CardHeader className="py-4 px-5">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">{t("Request a booth at this exhibition", "اطلب جناح في هذا المعرض")}</p>
          </div>
        </div>
      </CardHeader>
