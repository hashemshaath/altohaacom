...
export const ExhibitionVolunteerRegistration = memo(forwardRef<HTMLDivElement, Props>(function ExhibitionVolunteerRegistration({ exhibitionId, isAr }: Props, _ref) {
