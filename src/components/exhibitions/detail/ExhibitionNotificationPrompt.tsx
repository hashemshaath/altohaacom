...
export const ExhibitionNotificationPrompt = forwardRef<HTMLDivElement, Props>(function ExhibitionNotificationPrompt({ exhibitionId, exhibitionName, isAr, isFollowing }, ref) {
  const { user } = useAuth();
