...
export const ReferralShareSheet = memo(function ReferralShareSheet({ referralLink, referralCode, referralCodeId, compact }: ReferralShareSheetProps) {
  ...
  const shareTwitter = () => {
    ...
    window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(text)}&url=${encodeURIComponent(referralLink)}`, "_blank", "noopener,noreferrer");
  ...
  const shareTelegram = () => {
    window.open(`https://t.me/share/url?url=${encodeURIComponent(referralLink)}&text=${encodeURIComponent(getMessage())}`, "_blank", "noopener,noreferrer");
