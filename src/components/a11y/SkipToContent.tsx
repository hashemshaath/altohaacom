...
export function SkipToContent() {
  ...
  return (
    <>
      ...
      <a
        href="#site-footer"
        className="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:start-44 focus:z-[100] focus:rounded-lg focus:bg-secondary focus:px-4 focus:py-2 focus:text-secondary-foreground focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-ring"
      >
