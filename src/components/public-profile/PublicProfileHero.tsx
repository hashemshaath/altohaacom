                  ...
                  <div className="flex flex-wrap gap-1.5 justify-center md:justify-start pt-1">
                    {hashtags.map((tag, i) => (
                      <Link key={i} to={`/community?search=${encodeURIComponent(tag)}`}>
                        <Badge variant="outline" className="text-xs sm:text-xs h-5 sm:h-6 rounded-xl border-primary/20 text-primary/80 bg-primary/5 hover:bg-primary/10 transition-colors gap-0.5 px-2 cursor-pointer">
