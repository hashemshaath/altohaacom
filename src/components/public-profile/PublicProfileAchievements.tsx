              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{isAr ? "تصنيف عام" : "Overall"}</p>
                  </div>
                </div>
                {topRanking.rank && (
                  <div className="text-center">
                    ...
                    {topRanking.rank_change !== null && topRanking.rank_change !== 0 && (
                      <div className={`flex items-center justify-center gap-0.5 text-xs ${topRanking.rank_change > 0 ? "text-chart-2" : "text-destructive"}`}>
            ...
            <CardContent className="p-4 space-y-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground"><AnimatedCounter value={totalMedals} className="inline" /> {isAr ? "إجمالي" : "total"}</p>
                </div>
              </div>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex flex-col items-center gap-0.5 cursor-default">
                        ...
                        <span className="text-xs text-muted-foreground">{isAr ? "ذهب" : "Gold"}</span>
                      </div>
                    </TooltipTrigger>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex flex-col items-center gap-0.5 cursor-default">
                        ...
                        <span className="text-xs text-muted-foreground">{isAr ? "فضة" : "Silver"}</span>
                      </div>
                    </TooltipTrigger>
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex flex-col items-center gap-0.5 cursor-default">
                        ...
                        <span className="text-xs text-muted-foreground">{isAr ? "برونز" : "Bronze"}</span>
                      </div>
                    </TooltipTrigger>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground"><AnimatedCounter value={awards.length} className="inline" /> {isAr ? "جائزة" : "awards"}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 justify-center">
                {compStats.competitions > 0 && (
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-xs text-muted-foreground">{isAr ? "مسابقة" : "Competitions"}</span>
                  </div>
                )}
                {compStats.certificates > 0 && (
                  <div className="flex flex-col items-center gap-1">
                    ...
                    <span className="text-xs text-muted-foreground">{isAr ? "شهادة" : "Certificates"}</span>
                  </div>
                )}
              </div>
            </CardContent>
