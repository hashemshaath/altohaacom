        ...
        <CardContent className="p-4 space-y-3">
          ...
          {profile.nationality && (
            <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/30 rounded-xl px-3 py-2 border border-border/15">
              ...
              <Badge variant="outline" className="text-xs h-4 ms-auto border-border/30">{isAr ? "الجنسية" : "Nationality"}</Badge>
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            {profile.account_number && (
              <div className="flex items-center gap-2">
                ...
                <Badge variant="outline" className="font-mono text-xs border-border/30 tabular-nums">{profile.account_number}</Badge>
              </div>
            )}
          </div>
        </CardContent>
        ...
        <Card className="rounded-2xl border-primary/20 bg-gradient-to-br from-primary/5 to-chart-3/5 overflow-hidden hover:shadow-lg hover:shadow-primary/10 transition-all duration-500">
          <CardContent className="p-4 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-muted-foreground">{isAr ? "استمتع بمزايا حصرية" : "Enjoy exclusive benefits"}</p>
            </div>
            <Badge className="bg-primary text-primary-foreground text-xs rounded-xl">
