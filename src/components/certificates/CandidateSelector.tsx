              ...
              {competitions.map(c => (
                <SelectItem key={c.id} value={c.id}>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant="outline" className="text-xs ms-1">{c.status}</Badge>
                  </div>
                </SelectItem>
              ))}
            </SelectContent>
          ...
          <CardHeader className="pb-3">
            ...
            <div className="grid grid-cols-3 gap-3 mt-3">
              ...
              <div className="rounded-xl border p-2 text-center">
                ...
                <p className="text-xs text-muted-foreground">{language === "ar" ? "محددين" : "Selected"}</p>
              </div>
            </div>
          </CardHeader>
          <CardContent>
                          ...
                          <TableRow key={c.registrationId} className={alreadyIssued ? "opacity-60" : ""}>
                            ...
                            <TableCell>
                              <div className="flex gap-1">
                                <Badge variant="outline" className="text-xs">{language === "ar" ? "مشاركة" : "Participation"}</Badge>
                                {c.rank <= 3 && (
                                  <Badge className={`text-xs ${c.rank === 1 ? "bg-chart-4 text-chart-4-foreground" : c.rank === 2 ? "bg-muted-foreground text-background" : "bg-chart-3 text-chart-3-foreground"}`}>
                            ...
                            <TableCell>
                              {alreadyIssued ? (
                                <Badge className="bg-chart-5/20 text-chart-5 text-xs">
                                  <CheckCircle className="h-3 w-3 me-1" />
                                  {language === "ar" ? "صادرة" : "Issued"}
                                </Badge>
                              ) : (
                                <Badge variant="outline" className="text-xs">{language === "ar" ? "جديدة" : "New"}</Badge>
                              )}
                            </TableCell>
                            <TableCell>
