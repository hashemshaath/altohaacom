                  ...
                  {design.signatures.map(sig => (
                    <Card key={sig.id}>
                      <CardContent className="p-3 space-y-2">
                        <div className="flex items-center justify-between">
                          <Badge variant="outline" className="text-xs">{language === "ar" ? "توقيع" : "Signature"}</Badge>
                        ...
                        <div className="space-y-1">
                          <Label className="text-xs">{language === "ar" ? "صورة التوقيع (URL)" : "Signature Image (URL)"}</Label>
