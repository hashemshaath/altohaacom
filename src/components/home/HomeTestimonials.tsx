    ...
    <div>
      <section aria-label={isAr ? "آراء المستخدمين" : "Testimonials"} dir={isAr ? "rtl" : "ltr"}>
        <div className="container max-w-3xl">
          ...
          <Card className="border-border/40 shadow-lg relative overflow-hidden touch-pan-y rounded-2xl bg-card" onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
