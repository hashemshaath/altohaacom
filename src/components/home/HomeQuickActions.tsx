...
export const HomeQuickActions = memo(function HomeQuickActions() {
  ...
  return (
    <section className="container px-5 sm:px-6 py-1" dir={isAr ? "rtl" : "ltr"} aria-label={isAr ? "إجراءات سريعة" : "Quick actions"}>
      <div
      ...
      >
        {actions.map((a) => (
          ...
          >
            ...
            <span className="text-[11px] sm:text-[11px] font-semibold text-muted-foreground group-hover:text-foreground transition-colors line-clamp-1 whitespace-nowrap">
