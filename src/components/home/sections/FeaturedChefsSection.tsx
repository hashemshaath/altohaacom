          ...
          {isLoading
            ...
            : chefs.map((chef, idx) => {
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col items-center gap-3 rounded-2xl border border-border/30 <div className="flex flex-col items-center gap-3 rounded-2xl border border-border/30 bg-card p-5 transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:border-primary/20 hover:-translate-y-1 h-full active:scale-[0.98] shadow-sm"> transition-all duration-300 hover:shadow-lg hover:shadow-primary/5 hover:border-primary/20 hover:-translate-y-1 h-full active:scale-[0.98] shadow-sm">
                      <div className="relative">
                        <Avatar className={cn("h-16 w-16 ring-2 ring-border/30 transition-all duration-300 group-hover:ring-primary/40 group-hover:scale-105", idx < 3 && "ring-primary/30")}>
                          ...
                          <AvatarFallback className="bg-gradient-to-br from-primary/10 to-accent/10 text-foreground font-bold">{initials}</AvatarFallback>
                        </Avatar>
                        {chef.is_verified && (
