          ...
          <div className="flex flex-col gap-2.5 pt-2">
            <div className="flex items-center gap-3 rounded-2xl border border-border/30 bg-card/50 p-4 text-start transition-all hover:bg-card/80 hover:shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{isAr ? "تواصل مع زملائك مباشرة" : "Connect with peers directly"}</p>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-2xl border border-border/30 bg-card/50 p-4 text-start transition-all hover:bg-card/80 hover:shadow-sm">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10 shrink-0">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">{isAr ? "شارك الصور والملفات والمقاطع" : "Share images, files & recordings"}</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div key={msg.id}>
                  ...
                  {showDate && (
                    <div className="flex items-center gap-3 py-4">
                      ...
                      <span className="text-xs font-bold uppercase tracking-wider text-muted-foreground/70 bg-background px-3 py-1 rounded-full border border-border/20">
                  ...
                  <div id={`msg-${msg.id}`} className={`group flex ${isMine ? "justify-end" : "justify-start"} animate-fade-in ${highlightedMsgId === msg.id ? "ring-2 ring-primary/30 rounded-2xl bg-primary/5 p-1.5 -m-1.5 transition-all duration-500" : ""}`}>
                    <div className="relative max-w-[75%]">
                      ...
                      <div className={`rounded-2xl px-4 py-3 transition-all duration-200 hover:shadow-md ${
                        ...
                        <div className={`flex items-center gap-1 mt-1.5 text-xs ${isMine ? "text-primary-foreground/60 justify-end" : "text-muted-foreground"}`}>
