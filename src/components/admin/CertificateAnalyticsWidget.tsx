      ...
      <div className="grid gap-4 grid-cols-1 lg:grid-cols-2">
        ...
        <Card>
          <CardContent className="p-3">
            <p className="text-xs font-semibold text-muted-foreground mb-2">{isAr ? "حسب الحالة" : "By Status"}</p>
        ...
        <Card>
          <CardContent className="p-3">
            <p className="text-xs font-semibold text-muted-foreground mb-2">{isAr ? "حسب النوع" : "By Type"}</p>
