      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center p-2 rounded-xl bg-muted/50">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "تسجيلات" : "Registrations"}</p>
          </div>
          <div className="text-center p-2 rounded-xl bg-muted/50">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "معتمدة" : "Approved"}</p>
          </div>
          <div className="text-center p-2 rounded-xl bg-muted/50">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "تقييمات" : "Scores"}</p>
          </div>
        </div>
