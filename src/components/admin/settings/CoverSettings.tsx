        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2 items-end mt-2">
              <div className="space-y-1 flex-1">
                <Label className="text-xs text-muted-foreground">{isAr ? "أو أدخل اللون (HEX أو HSL)" : "Or enter color (HEX or HSL)"}</Label>
              ...
              {DIRECTION_OPTIONS.map(opt => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-1 rounded-xl border px-2 py-2.5 text-xs transition-all ${active ? "border-primary bg-primary/10 text-primary" : "border-border/40 text-muted-foreground hover:bg-muted/30"}`}
                  >
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline" className="text-xs font-mono px-2">{cover.gradientOpacityStart ?? 90}%</Badge>
              </div>
              <Slider
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline" className="text-xs font-mono px-2">{cover.gradientOpacityEnd ?? 0}%</Badge>
              </div>
              <Slider
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="text-xs font-mono px-2">{cover.gradientIntensity ?? 60}%</Badge>
            </div>
            <Slider
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-2 text-center text-xs font-medium text-foreground/70">
              ...
              >
                <div>
                  ...
                  <div className="flex gap-2 mt-0.5">
                    <Badge variant="outline" className="text-xs font-mono px-1.5 py-0">{t.width}×{t.height}</Badge>
                    <Badge variant="secondary" className="text-xs font-mono px-1.5 py-0">{t.ratio}</Badge>
                  </div>
                </div>
                <div
            ...
            {PAGE_OPTIONS.map(page => (
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="outline" className="text-xs font-mono px-1.5 py-0">{page.slug}</Badge>
                </div>
                <Select
