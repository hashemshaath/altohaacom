      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <Card className="border-border/40">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground">{analytics.approved.length} {isAr ? "تقدير" : "estimates"}</p>
          </CardContent>
        </Card>
        <Card className="border-border/40">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground">{analytics.invoiced.length} {isAr ? "فاتورة" : "invoices"}</p>
          </CardContent>
        </Card>
        <Card className="border-border/40">
          <CardContent className="p-4">
            ...
            <p className="text-xs text-muted-foreground">{analytics.pending.length} {isAr ? "تقدير" : "estimates"}</p>
          </CardContent>
        </Card>
        <Card className="border-border/40">
          <CardContent className="p-4">
