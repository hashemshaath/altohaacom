              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    {chef.experience_level && <Badge variant="secondary" className="text-xs h-4">{chef.experience_level}</Badge>}
                    {chef.specialization && <span className="text-xs text-muted-foreground truncate">{chef.specialization}</span>}
                  </div>
                </div>
              </button>
            ))
