...
export const UserInlineActions = memo(function UserInlineActions({
  ...
  return (
    <div className="flex items-center gap-1">
      <Button variant="ghost" size="icon" className="h-7 w-7 rounded-xl" onClick={onView} title={isAr ? "عرض" : "View"}>
        <Eye className="h-3.5 w-3.5" />
      </Button>
      <Button variant="ghost" size="icon" className="h-7 w-7 rounded-xl" onClick={onEdit} title={isAr ? "تعديل" : "Edit"}>
