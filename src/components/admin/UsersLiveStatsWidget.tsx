...
import { Users, UserCheck, UserPlus, Shield, Crown, Globe, Activity } from "lucide-react";
...
export const UsersLiveStatsWidget = memo(function UsersLiveStatsWidget() {
  const isAr = useIsAr();
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
          <div className="bg-muted/50 rounded-xl p-2 text-center">
            ...
            <div className="text-xs text-muted-foreground">{isAr ? "عضويات نشطة" : "Active Memberships"}</div>
          </div>
          <div className="bg-muted/50 rounded-xl p-2 text-center">
            ...
            <div className="text-xs text-muted-foreground">{isAr ? "مستخدم موثق" : "Verified Users"}</div>
          </div>
