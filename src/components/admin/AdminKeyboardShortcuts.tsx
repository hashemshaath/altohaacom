...
export const AdminKeyboardShortcuts = memo(function AdminKeyboardShortcuts() {
  ...
  return (
    <>
      ...
      {pendingKey && (
        <div className="fixed bottom-4 start-1/2 -translate-x-1/2 z-50 bg-card border border-border shadow-lg rounded-xl px-4 py-2 flex items-center gap-2 animate-in fade-in slide-in-from-bottom-2">
