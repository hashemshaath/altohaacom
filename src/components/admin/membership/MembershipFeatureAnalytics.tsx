...
function FeatureExportButton({ featureAgg }: { featureAgg: { name: string; nameAr: string; code: string; category: string; total: number; blocked: number; byTier: Record<string, number> }[] }) {
  const isAr = useIsAr();
