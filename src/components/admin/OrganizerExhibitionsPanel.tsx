              ...
              <div className="space-y-1">
                {availableExhibitions.slice(0, 20).map(exh => (
                  <div key={exh.id} className="flex items-center gap-2 p-2 rounded-lg hover:bg-muted/40 transition-colors">
                    ...
                    <Badge variant="outline" className="text-xs capitalize">{exh.status}</Badge>
                    <Button
                      size="sm"
                      variant="outline"
                  ...
                  <Card key={link.id} className="rounded-xl border-border/40 overflow-hidden group">
                    {exh.cover_image_url && (
                      <div className="h-16 w-full overflow-hidden">
                        <img src={exh.cover_image_url} alt={exh.title || "Exhibition cover"} className="w-full h-full object-cover" loading="lazy" />
                      </div>
                    )}
                    <CardContent className="p-3 space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <Badge variant={exh.status === "active" ? "default" : "secondary"} className="text-xs capitalize shrink-0">
                          {exh.status}
                        </Badge>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-7 text-xs text-destructive gap-1 px-2"
