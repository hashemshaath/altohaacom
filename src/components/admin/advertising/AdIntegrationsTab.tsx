        ...
        <CardContent className="p-3">
          <div className="flex items-center gap-2 mb-2">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground">{isAr ? "ربط بكسلات التتبع لتحليل أداء الحملات عبر المنصات المختلفة" : "Connect tracking pixels to analyze campaign performance across platforms"}</p>
            </div>
          </div>
          <div className="flex flex-wrap gap-1.5 mt-2">
            {INTEGRATIONS.map(int => (
              <Badge key={int.key} variant="outline" className="text-xs gap-1 rounded-xl">
