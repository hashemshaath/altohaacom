        ...
        <CardContent className="p-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground">{isAr ? "الصفحة العامة لعرض الباقات" : "Public page for displaying packages"}</p>
            </div>
          </div>
          ...
          >
            <CardContent className="p-5 space-y-3">
              <div className="text-center">
                ...
                <p className="text-[10px] text-muted-foreground">{pkg.duration_days} {isAr ? "يوم" : "days"}</p>
              </div>
