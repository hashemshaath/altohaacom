    ...
    <div className="border-t border-border/40 bg-muted/20 p-5 space-y-4">
      ...
      {session.notes && (
        <div className="rounded-xl border border-chart-4/20 bg-chart-4/5 p-4">
          <p className="text-xs font-bold text-chart-4 uppercase tracking-wider mb-2">
            {isAr ? "ملاحظات" : "Notes"}
          </p>
        ...
        <div className="rounded-xl border border-primary/20 bg-primary/5 p-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="outline"
              className="gap-1 shrink-0"
              onClick={() => window.open(`/evaluation-report/${(session as unknown as Record<string, unknown>).report_token}`, "_blank", "noopener,noreferrer")}
            >
