                    ...
                    return (
                      <tr key={bl.id} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                        <td className="p-3">
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <div className="min-w-0">
                              ...
                              <p className="text-xs text-muted-foreground truncate max-w-[200px]">{bl.source_url}</p>
                            </div>
                          </div>
                        </td>
                        ...
                        <td className="p-3 text-center">
                          <Badge variant={bl.is_dofollow ? "default" : "secondary"} className="text-xs">
                            {bl.is_dofollow ? "dofollow" : "nofollow"}
                          </Badge>
                        </td>
                        <td className="p-3 text-center">
                          <Badge variant={quality === "high" ? "default" : quality === "medium" ? "secondary" : "destructive"} className="text-xs">
