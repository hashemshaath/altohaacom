      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="text-base flex items-center gap-2">
            ...
            <Badge variant="secondary" className="text-xs ms-auto">{competitors.length} {isAr ? "منافس" : "tracked"}</Badge>
          </CardTitle>
        </CardHeader>
        <CardContent>
                  ...
                  <tr className="border-b border-border bg-primary/5">
                    <td className="p-3">
                      <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-primary/20 flex items-center justify-center text-xs font-bold text-primary">A</div>
                        <div>
                          <p className="font-medium text-sm">Altoha</p>
                          <p className="text-xs text-muted-foreground">{ourSite.domain}</p>
                        </div>
                        <Badge className="text-xs">{isAr ? "أنت" : "You"}</Badge>
                      </div>
                    </td>
                  ...
                  {competitors.map(comp => {
                    ...
                    return (
                      <tr key={comp.id} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                        <td className="p-3">
                          <div className="flex items-center gap-2">
                            <div className="h-6 w-6 rounded-full bg-muted flex items-center justify-center text-xs font-bold">{comp.name[0]}</div>
                            <div>
                        ...
                        <td className="p-3 text-center">
                          ...
                          {daDiff !== 0 && (
                            <span className={`text-xs ms-1 ${daDiff > 0 ? "text-destructive" : "text-green-500"}`}>
