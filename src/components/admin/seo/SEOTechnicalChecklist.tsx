          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-3">
              <div className="text-center">
                ...
                <p className="text-xs text-muted-foreground uppercase tracking-wider">{isAr ? "النتيجة" : "Score"}</p>
              </div>
          ...
          <Card key={cat.key}>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm flex items-center gap-2">
                ...
                {isAr ? cat.ar : cat.en}
                <Badge variant={catPass === catChecks.length ? "default" : "secondary"} className="text-xs ms-auto">
              ...
              {catChecks.map(check => (
                <div key={check.id} className="flex items-start gap-3 py-2.5 px-3 rounded-lg hover:bg-muted/30 transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground">{isAr ? check.descriptionAr : check.description}</p>
                  </div>
                  <Badge
