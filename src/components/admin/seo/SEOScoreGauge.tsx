          ...
          <div className="flex-1 space-y-3">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="text-center rounded-xl bg-muted/40 p-2.5">
                ...
                <p className="text-[9px] text-muted-foreground">{isAr ? "Web Vitals" : "CWV Pass"}</p>
              </div>
              <div className="text-center rounded-xl bg-muted/40 p-2.5">
                <div className="flex items-center justify-center gap-1 mb-0.5">
                ...
                <p className="text-[9px] text-muted-foreground">{isAr ? "مفهرسة" : "Indexed"}</p>
              </div>
              <div className="text-center rounded-xl bg-muted/40 p-2.5">
                <div className="flex items-center justify-center gap-1 mb-0.5">
                  {issueCount === 0 ? (
                ...
                <p className="text-[9px] text-muted-foreground">{isAr ? "مشاكل" : "Issues"}</p>
              </div>
            </div>
          </div>
        </div>
