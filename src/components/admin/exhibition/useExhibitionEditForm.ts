...
import {
  Landmark, Calendar, MapPin, Building, Ticket, Globe,
  Link as LinkIcon, Award, Trophy, FileText, History,
  Users, StickyNote, Camera,
} from "lucide-react";
...
export const typeOptions: { value: ExhibitionType; en: string; ar: string; icon: LucideIcon }[] = [
  { value: "exhibition", en: "Exhibition", ar: "معرض", icon: Landmark },
  { value: "conference", en: "Conference", ar: "مؤتمر", icon: Globe },
  { value: "summit", en: "Summit", ar: "قمة", icon: Globe },
  { value: "workshop", en: "Workshop", ar: "ورشة عمل", icon: Globe },
  { value: "food_festival", en: "Food Festival", ar: "مهرجان طعام", icon: Globe },
...
export function useExhibitionEditForm(exhibition: any | undefined, onClose: () => void) {
  ...
  return {
    isAr, t, form, setForm, updateField,
    editingId, originalEditingId,
    organizer, setOrganizer,
    currency, setCurrency, countries,
    ...
    existingEdition, editionLoading,
    previousEditions,
    editionHasData, formLocked, editionFieldsDisabled,
    sectionRefs, scrollContainerRef,
    getSectionStatus, completeness, scrollToSection,
    saveMutation, currentStatus, currentType,
