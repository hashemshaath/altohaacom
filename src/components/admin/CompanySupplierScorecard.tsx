...
import { Building2, Search, Star, TrendingUp, Package, Filter, ArrowUpDown } from "lucide-react";
                  ...
                  return (
                    <TableRow key={company.id}>
                      <TableCell>
                        <div className="flex items-center gap-2">
                          {company.logo_url ? (
                            <img loading="lazy" decoding="async" src={company.logo_url} alt={company.name || "Company"} className="h-7 w-7 rounded object-cover" />
                          ) : (
