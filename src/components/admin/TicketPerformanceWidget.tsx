      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-3 gap-2">
          <div className="text-center p-2 rounded-xl bg-muted/50 group transition-all duration-300 hover:shadow-sm hover:-translate-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "متوسط الحل" : "Avg Resolve"}</p>
          </div>
          <div className="text-center p-2 rounded-xl bg-muted/50 group transition-all duration-300 hover:shadow-sm hover:-translate-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "نسبة الحل" : "Resolve Rate"}</p>
          </div>
          <div className="text-center p-2 rounded-xl bg-muted/50 group transition-all duration-300 hover:shadow-sm hover:-translate-y-0.5">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "تجاوز SLA" : "SLA Breach"}</p>
          </div>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {stats.byPriority.high > 0 && (
              <Badge className="bg-chart-4/15 text-chart-4 text-xs" variant="outline">
