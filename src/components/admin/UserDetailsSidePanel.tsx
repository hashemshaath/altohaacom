            ...
            <div className="space-y-4 pe-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    {profile.is_verified && (
                      <Badge variant="outline" className="text-xs border-primary/30 text-primary gap-0.5">
                  ...
                  <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                    <Badge variant="outline" className={cn("text-xs gap-1", currentStatus.cls)}>
                    ...
                    {data.roles.length > 3 && <Badge variant="outline" className="text-xs">+{data.roles.length - 3}</Badge>}
                  </div>
                </div>
              </div>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList className="w-full rounded-xl bg-muted/40 p-1 h-auto">
                  <TabsTrigger value="overview" className="text-xs flex-1 rounded-lg gap-1">
                    <BarChart3 className="h-3 w-3" />{isAr ? "نظرة عامة" : "Overview"}
                  </TabsTrigger>
                  <TabsTrigger value="roles" className="text-xs flex-1 rounded-lg gap-1">
                    <Shield className="h-3 w-3" />{isAr ? "الأدوار" : "Roles"}
                  </TabsTrigger>
                  <TabsTrigger value="activity" className="text-xs flex-1 rounded-lg gap-1">
                    ...
                    return (
                      <div key={role} className={cn(
                        ...
                        <Button
                          ...
                          size="sm"
                          className={cn("h-6 text-xs px-2 rounded-lg", hasRole && "text-destructive border-destructive/30 hover:bg-destructive/10")}
