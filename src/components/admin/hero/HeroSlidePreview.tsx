...
function ClassicTemplate({ slide }: { slide: HeroSlide }) {
  ...
  return (
    <section className="relative overflow-hidden" style={getHeightStyle(slide)}>
      <img loading="lazy" decoding="async" src={slide.image_url} alt={slide.title} fetchPriority="high" decoding="async" className="absolute inset-0 h-full w-full scale-105" style={getImageStyle(slide)} />
...
function CenteredTemplate({ slide }: { slide: HeroSlide }) {
  return (
    <section className="relative flex items-center justify-center overflow-hidden" style={getHeightStyle(slide)}>
      <img loading="lazy" decoding="async" src={slide.image_url} alt={slide.title} className="absolute inset-0 h-full w-full scale-105" style={getImageStyle(slide)} />
      <div className="absolute inset-0" style={{ background: buildGradient(slide) }} />
...
function SplitTemplate({ slide }: { slide: HeroSlide }) {
  return (
    <section className="relative overflow-hidden" style={getHeightStyle(slide)}>
      <img loading="lazy" decoding="async" src={slide.image_url} alt={slide.title} className="absolute inset-0 h-full w-full" style={getImageStyle(slide)} />
      {/* Frosted panel */}
...
function EditorialTemplate({ slide }: { slide: HeroSlide }) {
  return (
    <section className="relative overflow-hidden" style={getHeightStyle(slide)}>
      <img loading="lazy" decoding="async" src={slide.image_url} alt={slide.title} className="absolute inset-0 h-full w-full scale-[1.03]" style={getImageStyle(slide)} />
