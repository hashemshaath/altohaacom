...
export const ProfileShareButtons = memo(function ProfileShareButtons({ username, displayName, variant = "icon" }: ProfileShareButtonsProps) {
  ...
  const shareLinks = [
    ...
    },
    {
      label: "X / Twitter",
      icon: Twitter,
      action: () => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(profileUrl)}`, "_blank", "noopener,noreferrer"),
    },
    {
      label: "LinkedIn",
      icon: Linkedin,
      action: () => window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(profileUrl)}`, "_blank", "noopener,noreferrer"),
    },
    {
      label: "Facebook",
      icon: Facebook,
    ...
    },
    {
      label: "WhatsApp",
      icon: Send,
      action: () => window.open(`https://wa.me/?text=${encodeURIComponent(shareText + " " + profileUrl)}`, "_blank", "noopener,noreferrer"),
    },
  ];
