              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {"trend" in stat && (stat as any).trend !== undefined && (stat as any).trend !== 0 && (
                    <p className={`text-xs font-medium ${(stat as any).trend > 0 ? "text-chart-5" : "text-destructive"}`}>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {"trend" in stat && stat.trend !== undefined && stat.trend !== 0 && (
                        <p className={`text-xs font-medium ${(stat.trend as number) > 0 ? "text-chart-5" : "text-destructive"}`}>
