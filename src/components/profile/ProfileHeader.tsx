...
import { Camera, MapPin, ChefHat, Shield, Crown, Star, Eye, Link2, Copy, Check, Share2, ExternalLink, Sparkles, Users, UserPlus, LucideIcon } from "lucide-react";
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2.5">
            <div className="flex items-center gap-2.5 flex-wrap">
              <h1 className={`typo-user-name sm:text-3xl lg:text-4xl tracking-tight text-foreground break-words ${language !== "ar" ? "font-serif" : ""}`}>
