              ...
              {topPages.map((p, i) => (
                <div key={i} className="flex items-center justify-between p-2.5 rounded-xl bg-muted/50">
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-muted-foreground">{p.impressions} {isAr ? "مشاهدة" : "imp."}</p>
                  </div>
                  <div className="text-end shrink-0 ms-3">
                    <Badge variant="secondary" className="text-xs">{p.ctr}% CTR</Badge>
                  </div>
                </div>
              ))}
            </div>
              ...
              {campaignPerformance.slice(0, 6).map((c, i) => (
                <div key={i} className="flex items-center justify-between p-2.5 rounded-xl bg-muted/50">
                  ...
                  <div className="text-end">
                    ...
                    <p className="text-xs text-muted-foreground"><AnimatedCounter value={c.impressions} className="inline" /> {isAr ? "مشاهدة" : "imp."} · <AnimatedCounter value={c.clicks} className="inline" /> {isAr ? "نقرة" : "clicks"}</p>
                  </div>
                </div>
              ))}
            </div>
