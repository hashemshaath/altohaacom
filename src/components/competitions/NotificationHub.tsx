      ...
      <div className="grid gap-3 grid-cols-3">
        <Card>
          <CardContent className="pt-4 pb-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "مشاركون" : "Participants"}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4 pb-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "حكام" : "Judges"}</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="pt-4 pb-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "إشعارات" : "Sent"}</p>
          </CardContent>
        </Card>
      </div>
