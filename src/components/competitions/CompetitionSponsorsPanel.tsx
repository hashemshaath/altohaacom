        ...
        {isOrganizer && pendingSponsors.length > 0 && (
          <div className="space-y-2">
            <p className="text-sm font-medium flex items-center gap-2">
              ...
              <Badge variant="secondary" className="text-xs">{pendingSponsors.length}</Badge>
            </p>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="min-w-0 flex-1">
                              ...
                              <Badge variant="outline" className={`mt-1 text-xs uppercase tracking-wider ${config.color}`}>
