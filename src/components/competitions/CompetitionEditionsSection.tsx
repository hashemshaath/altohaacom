  ...
  return (
    <section ref={ref} className="space-y-4" aria-label={isAr ? "إصدارات المسابقات" : "Competition Series & Editions"}>
      <div className="flex items-center gap-2.5">
        ...
        <Badge variant="secondary" className="ms-auto text-xs font-bold rounded-lg">
                ...
                <CardContent className="flex items-center gap-3 p-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-1 flex items-center gap-2 flex-wrap">
                      <Badge variant="outline" className="text-xs gap-1 rounded-lg h-5">
                                ...
                                <div className="flex items-center gap-2 mb-1">
                                  {edition.edition_year && (
                                    <Badge
                                      ...
                                      className="text-xs font-black rounded-lg h-5 px-2"
                                    >
                                      {edition.edition_year}
                                    </Badge>
                                  )}
                                  <Badge
                                    className={`text-xs h-4 px-1.5 rounded-md border-0 ${derived.color}`}
                                  >
                                    {isAr ? derived.labelAr : derived.label}
                                  </Badge>
                                  {isFirst && (
                                    <Badge className="text-xs h-4 px-1.5 rounded-md border-0 bg-chart-3/10 text-chart-3">
                                      {isAr ? "أحدث" : "Latest"}
                                    </Badge>
                                  )}
                                </div>
