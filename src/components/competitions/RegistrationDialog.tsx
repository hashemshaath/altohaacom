        ...
        <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {teamMembers.map((member, idx) => (
                    <div key={idx} className="flex items-center gap-2 rounded border p-2 bg-background">
                      <Avatar className="h-7 w-7">
                        ...
                        <AvatarFallback className="text-xs">{(member.member_name || "?")[0]}</AvatarFallback>
                      </Avatar>
                      <Input
                      ...
                      />
                      {member.is_captain && <Badge variant="secondary" className="text-xs shrink-0">{isAr ? "قائد" : "Captain"}</Badge>}
          ...
          <div className="space-y-2">
            ...
            {imagePreview ? (
              ...
              >
                ...
                <p className="text-xs text-muted-foreground/60 mt-0.5">{isAr ? "الحد الأقصى 5 ميجابايت" : "Max 5MB • JPG, PNG, WebP"}</p>
              </div>
            )}
          </div>
          ...
          {isPaid && (
            <div className="rounded-2xl border border-primary/15 bg-primary/[0.02] p-4 sm:p-5 space-y-3">
              ...
              <Badge variant="secondary" className="text-xs font-medium rounded-xl">
