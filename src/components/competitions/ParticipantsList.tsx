            ...
            <Tabs value={activeSubTab} onValueChange={setActiveSubTab} className="mb-3">
              <TabsList className="h-9">
                <TabsTrigger value="list" className="text-xs gap-1">
                  ...
                  {isAr ? "القائمة" : "List"}
                  <Badge variant="secondary" className="text-xs h-4 px-1">{statusCounts.total}</Badge>
                </TabsTrigger>
                ...
                <TabsTrigger value="invitations" className="text-xs gap-1">
                  ...
                  {invitations.length > 0 && (
                    <Badge variant="secondary" className="text-xs h-4 px-1">{invitations.length}</Badge>
                  )}
                </TabsTrigger>
              </TabsList>
            </Tabs>
            ...
            <>
              <div className="flex flex-wrap gap-2 mb-3">
                {[
                  ...
                  >
                    {f.label}
                    <Badge variant="secondary" className="text-xs h-4 px-1">{f.count}</Badge>
                  </Button>
                ))}
              </div>
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0 space-y-1">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              <Badge variant={inv.status === "accepted" ? "default" : inv.status === "declined" ? "destructive" : "secondary"} className="text-xs h-5">
                            ...
                            {(inv.organization_name || inv.organization_name_ar) && (
                              <p className="text-xs text-muted-foreground flex items-center gap-1">
                                ...
                                {inv.organization_type && inv.organization_type !== "other" && (
                                  <Badge variant="outline" className="text-xs h-4 px-1 ms-1">
                      ...
                      <div className="flex gap-3 p-4">
                        ...
                        <div className="flex-1 min-w-0 space-y-1">
                          <div className="flex items-start justify-between gap-1">
                            ...
                            <Badge className={`${status.className} text-xs h-5 shrink-0`}>
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {participant.company && (
                              <Badge variant="outline" className="text-xs h-4 px-1 gap-0.5">
