                  ...
                  return (
                    ...
                    >
                      <div className="flex gap-3">
                        {exh.cover_image_url && (
                          <img src={exh.cover_image_url} alt={exh.title || "Exhibition"} className="h-14 w-20 rounded-xl object-cover shrink-0" loading="lazy" />
                        )}
              ...
              <div className="grid gap-2 max-h-[350px] overflow-y-auto pe-1">
                {filteredEntities?.map((ent) => {
                  ...
                  return (
                    ...
                    >
                      {ent.logo_url ? (
                        <img src={ent.logo_url} alt={ent.name || "Entity"} className="h-10 w-10 rounded-xl object-cover shrink-0" loading="lazy" />
                      ) : (
              ...
              <div className="grid gap-2 max-h-[350px] overflow-y-auto pe-1">
                {filteredChefs?.map((chef) => {
                  ...
                  return (
                    ...
                    >
                      {chef.avatar_url ? (
                        <img src={chef.avatar_url} alt={chef.full_name || "Chef"} className="h-10 w-10 rounded-full object-cover shrink-0" loading="lazy" />
                      ) : (
