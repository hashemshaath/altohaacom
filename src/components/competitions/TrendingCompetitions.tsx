      ...
      <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-none -mx-4 px-4 md:mx-0 md:px-0">
        {trending.map((comp) => {
          ...
          return (
            ...
            >
              <Card className="overflow-hidden rounded-2xl border-border/20 h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1 hover:border-primary/20">
                {/* Image */}
                <div className="relative aspect-[16/9] overflow-hidden bg-muted">
                  ...
                  <div className="absolute top-2 start-2">
                    <Badge className={`text-[8px] font-black border-0 rounded-lg px-2 py-0.5 backdrop-blur-md ${derived.color}`}>
