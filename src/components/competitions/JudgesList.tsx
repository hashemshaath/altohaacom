                ...
                <div key={judge.id} className="relative group">
                  ...
                  {isHeadJudge && (
                    <div className="absolute -top-2 start-3 z-10">
                      <Badge className="gap-1 bg-amber-500 text-amber-50 hover:bg-amber-600 shadow-md text-xs px-2 py-0.5">
                  ...
                  >
                    ...
                    <div className="border-t bg-muted/20 px-4 py-2 flex items-center gap-2 flex-wrap">
                      {isHeadJudge && (
                        <Badge className="text-xs h-5 gap-0.5 bg-amber-500/10 text-amber-600 border-amber-300">
                      ...
                      {jp?.judge_category && (
                        <Badge variant="secondary" className="text-xs h-5">{jp.judge_category}</Badge>
                      )}
                      {judge.scoresGiven > 0 && (
                        <Badge variant="outline" className="text-xs h-5 gap-0.5 ms-auto">
