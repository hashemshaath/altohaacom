        ...
        Object.entries(groupedByDate).map(([dateKey, daySlots]) => (
          <div key={dateKey}>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-xs text-muted-foreground">{daySlots!.length} {isAr ? "فترة" : "slots"}</span>
            </div>
                  ...
                  <div key={slot.id} className="relative flex items-center gap-3 rounded-xl border border-border/50 p-3 hover:bg-muted/30 transition-colors group">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant="outline" className="text-xs">{slotType ? (isAr ? slotType.ar : slotType.en) : slot.slot_type}</Badge>
                      </div>
