    ...
    return (
      <div className={`flex items-center gap-3 ${className}`}>
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          ...
          {qrCode && (
            <span className="font-mono text-xs text-muted-foreground tracking-widest">{qrCode.code}</span>
          )}
        </div>
      </div>
    );
      ...
      <CardContent className="p-4 flex flex-col items-center gap-3">
        ...
        <div className="flex items-center gap-3 w-full">
          ...
          <div className="min-w-0 flex-1">
            ...
            {categoryName && (
              <Badge variant="outline" className="text-xs mt-0.5">{categoryName}</Badge>
            )}
          </div>
        </div>
        ...
        <p className="text-xs text-center text-muted-foreground line-clamp-1">{competitionTitle}</p>
