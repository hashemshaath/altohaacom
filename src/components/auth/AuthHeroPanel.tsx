...
export const AuthHeroPanel = memo(function AuthHeroPanel({
  ...
  return (
    <div className="hidden md:flex md:w-[500px] lg:w-[620px] xl:w-[720px] relative flex-col overflow-hidden border-e border-white/5 self-stretch min-h-[100dvh] sticky top-0">
