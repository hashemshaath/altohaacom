...
export const InvitationManager = memo(function InvitationManager() {
  ...
  const statusBadge = (s: string) => {
    ...
    return <Badge variant={variants[s] || "secondary"} className="text-xs uppercase gap-1">{statusIcon(s)}{s}</Badge>;
  };
  const stats = useMemo(() => ({
                ...
                <TableBody>
                  {filteredCandidates.map(c => (
                    ...
                    >
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-muted-foreground font-mono">{c.account_number}</p>
                          </div>
                        </div>
                      </TableCell>
                      ...
                      <TableCell>
                        {c.judge_level ? (
                          <Badge variant={c.judge_level === "international" ? "default" : "secondary"} className="text-xs">
                            {c.judge_level}
                          </Badge>
                        ) : "—"}
                      </TableCell>
