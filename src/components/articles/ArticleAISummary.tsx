      ...
      >
        ...
        <div className="flex-1">
          <p className="text-xs font-semibold flex items-center gap-2">
            ...
            <span className="text-xs font-normal text-muted-foreground uppercase">{lang}</span>
          </p>
        </div>
        ...
        <div className="px-4 pb-4">
          ...
          {summary && (
            <div className="flex items-center gap-2 mt-3 pt-2 border-t border-border/20">
              <Button variant="ghost" size="sm" className="h-7 text-xs rounded-lg gap-1" onClick={toggleLang}>
                <Languages className="h-3 w-3" />
                {lang === "en" ? "بالعربية" : "In English"}
              </Button>
              <Button variant="ghost" size="sm" className="h-7 text-xs rounded-lg gap-1" onClick={generateSummary}>
