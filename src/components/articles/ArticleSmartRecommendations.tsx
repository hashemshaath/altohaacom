                ...
                <CardContent className="p-0 flex">
                  {article.featured_image_url ? (
                    <div className="w-28 sm:w-36 relative overflow-hidden shrink-0">
                      ...
                      <div className="absolute top-2 start-2">
                        <Badge className="text-[8px] rounded-lg px-1.5 py-0 h-4 bg-chart-4/90 text-white border-0">
                  ...
                  <div className="flex-1 p-3.5 sm:p-4 min-w-0 flex flex-col justify-between">
                    <div>
                      ...
                      {e && (
                        <p className="text-[11px] text-muted-foreground line-clamp-1 leading-relaxed">{e}</p>
                      )}
                    </div>
