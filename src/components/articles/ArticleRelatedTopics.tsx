      ...
      <div className="flex flex-wrap gap-1.5 mb-5">
        {articleTags.map(tag => (
          <Badge
            key={tag.id}
            variant="secondary"
            className="rounded-xl text-xs px-2.5 py-1 gap-1 cursor-default"
          >
                ...
                <CardContent className="p-3.5 flex gap-3">
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-2 mt-1.5">
                      <Badge variant="outline" className="text-xs px-1.5 py-0 h-4 rounded-md border-primary/20 text-primary gap-0.5">
