    ...
    <Card className="rounded-2xl border-border/40 bg-card/80 backdrop-blur-sm overflow-hidden">
      <CardContent className="p-5">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge variant="outline" className="text-xs rounded-lg px-2 py-0 h-5 border-border/40">
        ...
        <div className="flex items-center gap-1.5 mt-4 pt-3 border-t border-border/20">
          <span className="text-xs text-muted-foreground/50">{isAr ? "أقل" : "Less"}</span>
          ...
          <span className="text-xs text-muted-foreground/50">{isAr ? "أكثر" : "More"}</span>
        </div>
      </CardContent>
    </Card>
  );
