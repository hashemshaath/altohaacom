      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2">
          <div className="rounded-xl border border-border/50 p-2.5 text-center">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "مخزنة" : "Cached"}</p>
          </div>
          <div className="rounded-xl border border-border/50 p-2.5 text-center">
            ...
            <p className="text-xs text-muted-foreground">{isAr ? "بانتظار المزامنة" : "Pending"}</p>
          </div>
          <div className="rounded-xl border border-border/50 p-2.5 text-center">
            <Clock className="h-4 w-4 mx-auto text-muted-foreground mb-1" />
            <p className="text-xs font-medium mt-0.5 leading-tight">{lastSyncText}</p>
            <p className="text-xs text-muted-foreground">{isAr ? "آخر مزامنة" : "Last sync"}</p>
          </div>
        </div>
