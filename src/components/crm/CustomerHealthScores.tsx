    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <Badge variant="outline" className="bg-chart-3/10 text-chart-3 text-xs">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div className="text-end w-14">
                    ...
                    <Badge variant="outline" className={`text-xs px-1 py-0 ${getScoreBg(customer.score)} ${getScoreColor(customer.score)}`}>
