          ...
          >
            ...
            {(r.exhibition_title || r.organizer_name) && (
              <div className="pt-2 border-t border-border/20">
                {r.exhibition_title && (
                  <p className="text-[9px] text-muted-foreground truncate">{r.exhibition_title}</p>
                )}
                {r.organizer_name && (
                  <p className="text-[9px] text-primary/70 font-medium truncate">{isAr ? "بواسطة" : "by"} {r.organizer_name}</p>
                )}
              </div>
            )}
          </div>
