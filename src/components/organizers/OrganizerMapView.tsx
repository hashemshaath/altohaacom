  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 mb-1">
        ...
        <Badge variant="secondary" className="text-xs">{grouped.length} {isAr ? "دولة" : "countries"}</Badge>
      </div>
            ...
            <div key={group.country} className="rounded-2xl border border-border/40 bg-card overflow-hidden">
              ...
              >
                ...
                <div className="flex -space-x-2 rtl:space-x-reverse shrink-0">
                  ...
                  {group.orgs.length > 3 && (
                    <div className="flex h-7 w-7 items-center justify-center rounded-lg border-2 border-background bg-muted text-xs font-bold text-muted-foreground">
                      +{group.orgs.length - 3}
                    </div>
                  )}
                </div>
