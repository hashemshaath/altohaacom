...
export const LiveCompetitionsWidget = memo(function LiveCompetitionsWidget() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <Badge variant={s.variant} className="text-xs px-1.5 py-0">
        ...
        {competitions.map(comp => {
          ...
          return (
            <div key={comp.id} className="group rounded-xl border border-border/30 p-3 transition-colors hover:bg-muted/30">
              ...
              <Button variant="ghost" size="sm" className="w-full mt-2 h-7 text-xs gap-1 text-primary opacity-0 group-hover:opacity-100 transition-opacity" asChild>
