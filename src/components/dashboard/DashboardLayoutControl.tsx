...
const DEFAULT_WIDGETS: WidgetConfig[] = [
  ...
  { id: "daily-digest", labelEn: "Daily Digest", labelAr: "الملخص اليومي", visible: true },
  { id: "weekly-overview", labelEn: "Weekly Overview", labelAr: "نظرة أسبوعية", visible: true },
  ...
  { id: "live-competitions", labelEn: "Live Competitions", labelAr: "مسابقات مباشرة", visible: true },
  { id: "masterclass", labelEn: "Masterclass", labelAr: "الدورات", visible: true },
  { id: "recommendations", labelEn: "Recommendations", labelAr: "توصيات", visible: true },
  { id: "weekly-trend", labelEn: "Weekly Trend", labelAr: "اتجاه أسبوعي", visible: true },
  { id: "activity-heatmap", labelEn: "Activity Heatmap", labelAr: "خريطة النشاط", visible: true },
  { id: "profile-insights", labelEn: "Profile Insights", labelAr: "رؤى الملف", visible: true },
  { id: "platform-score", labelEn: "Platform Score", labelAr: "نقاط المنصة", visible: true },
  { id: "wallet", labelEn: "Wallet", labelAr: "المحفظة", visible: true },
  { id: "streak", labelEn: "Streak", labelAr: "سلسلة النشاط", visible: true },
  { id: "quick-actions", labelEn: "Quick Actions", labelAr: "إجراءات سريعة", visible: true },
  { id: "engagement", labelEn: "Engagement", labelAr: "التفاعل", visible: true },
  { id: "notification-digest", labelEn: "Notification Digest", labelAr: "ملخص الإشعارات", visible: true },
  { id: "notification-groups", labelEn: "Notification Groups", labelAr: "مجموعات الإشعارات", visible: true },
  { id: "notification-activity", labelEn: "Notification Activity", labelAr: "نشاط الإشعارات", visible: true },
  { id: "recent-chats", labelEn: "Recent Chats", labelAr: "محادثات حديثة", visible: true },
  { id: "goals", labelEn: "Goals & Milestones", labelAr: "الأهداف والإنجازات", visible: true },
  { id: "achievements-challenges", labelEn: "Challenges", labelAr: "التحديات", visible: true },
  { id: "recent-orders", labelEn: "Recent Orders", labelAr: "طلبات حديثة", visible: true },
  ...
  { id: "message-search", labelEn: "Message Search", labelAr: "بحث الرسائل", visible: true },
    ...
    <Popover>
      ...
      <PopoverContent className="w-72 p-0" align="end">
        <div className="flex items-center justify-between border-b px-3 py-2">
          ...
          <Button variant="ghost" size="sm" className="h-6 text-xs gap-1" onClick={resetLayout}>
