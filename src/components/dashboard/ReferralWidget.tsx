      ...
      <CardContent className="p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">{isAr ? "اكسب نقاطاً لكل صديق" : "Earn points per friend"}</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 gap-1.5 mb-4">
          <div className="rounded-xl bg-muted/50 p-2 text-center">
            ...
            <p className="text-xs text-muted-foreground uppercase">{isAr ? "دعوات" : "Invites"}</p>
          </div>
          <div className="rounded-xl bg-muted/50 p-2 text-center">
            <p className="text-lg font-bold">{converts}</p>
            <p className="text-xs text-muted-foreground uppercase">{isAr ? "تحويلات" : "Converts"}</p>
          </div>
          <div className="rounded-xl bg-muted/50 p-2 text-center">
            ...
            <p className="text-xs text-muted-foreground uppercase">{isAr ? "معدل" : "Rate"}</p>
          </div>
        </div>
