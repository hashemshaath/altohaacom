                ...
                return (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <div className="flex-1 relative">
                      ...
                      >
                        <span className="text-xs font-bold text-primary-foreground">{edge.count}</span>
                      </div>
                    </div>
                  </div>
                );
                  ...
                  <div key={i} className="space-y-1">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge variant={drop.exitRate > 70 ? "destructive" : drop.exitRate > 50 ? "secondary" : "outline"} className="text-xs">
                          {drop.exitRate}%
                        </Badge>
                      </div>
                    </div>
