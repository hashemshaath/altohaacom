            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <Badge className="bg-primary/10 text-primary border-primary/20 uppercase text-xs tracking-widest px-3 py-1">
                    {company.type}
                  </Badge>
                  {company.is_verified && (
                    <Badge className="bg-chart-5/10 text-chart-5 border-chart-5/20 gap-1 text-xs">
                      <CheckCircle className="h-3 w-3" />
                      {isAr ? "موثّق" : "Verified"}
                    </Badge>
                  )}
                  {company.company_number && (
                    <Badge variant="outline" className="bg-muted/50 font-mono text-xs px-3 py-1">
                      <Hash className="me-1 h-3 w-3" />
                      {company.company_number}
                    </Badge>
                  )}
                  {company.country_code && (
                    <Badge variant="outline" className="bg-muted/50 text-xs px-3 py-1">
