...
import {
  Bell, Send, Mail, MessageSquare, Smartphone, Clock, Check, X,
  AlertCircle, BarChart3, RefreshCw, Megaphone, Filter, ChevronDown,
  ChevronUp, Trash2, RotateCcw, Eye, Users, Zap, Target, TrendingUp,
  XSquare, Download, Sparkles,
} from "lucide-react";
                    ...
                    <Card key={t.id} className="hover:shadow-md transition-shadow">
                      <CardContent className="p-4 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1">{getChannelIcon(t.channel)}<span className="text-xs capitalize text-muted-foreground">{t.channel}</span></div>
                        </div>
