                    ...
                    <div key={gi} className="border rounded-xl p-3 bg-destructive/5 space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <span className="text-xs text-muted-foreground">{group.primary.identifier} • {group.primary.city || "—"}</span>
                        </div>
                        <Badge variant="secondary" className="text-xs">{isAr ? "الأساسي" : "Primary"}</Badge>
                      </div>
                      {/* Matches */}
                          ...
                          return (
                            <div key={`${result.table}-${gi}`} className="flex items-center gap-3 p-3 rounded-xl border border-orange-500/30 bg-orange-500/5">
                              <div className="flex-1 min-w-0 space-y-1">
                                ...
                                <div className="flex items-center gap-2">
                                  <Badge variant="outline" className="text-xs">{tblInfo?.icon} {isAr ? tblInfo?.label_ar : tblInfo?.label_en}</Badge>
                                  ...
                                  {group.matches[0].reasons.slice(0, 2).map((r, ri) => (
                                    <span key={ri} className="text-xs bg-muted px-1.5 py-0.5 rounded">{r}</span>
                                  ))}
                                </div>
                              </div>
                              <Button
