          ...
          <Card key={label} className="rounded-2xl border-border/50 bg-card/80 backdrop-blur-sm overflow-hidden group hover:shadow-md hover:-translate-y-0.5 transition-all duration-300">
            <CardContent className="flex items-center gap-3 p-3 sm:p-4">
              ...
              <div className="min-w-0">
                <p className="text-xs sm:text-xs text-muted-foreground font-medium truncate">{label}</p>
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-1">
                          ...
                          <Badge
                            variant="outline"
                            className={cn(
                              "text-xs shrink-0 px-1.5 rounded-md",
                        ...
                        <p className="text-xs text-muted-foreground truncate mt-0.5">{session.subject}</p>
                        <div className="flex items-center gap-2 mt-0.5">
                          {waitMins !== null && waitMins > 5 && (
                            <span className="text-xs text-chart-4 font-semibold tabular-nums">{waitMins}m</span>
                          )}
                          {session.rating && (
                            <div className="flex items-center gap-0.5">
                              <Star className="h-2.5 w-2.5 text-chart-5 fill-chart-5" />
                              <span className="text-xs text-chart-5 font-medium">{session.rating}</span>
                            </div>
                          )}
                        </div>
                      </div>
