                  ...
                  <tbody>
                    {filteredOrders.length === 0 ? (
                      ...
                      <tr key={o.order_number} className="border-b last:border-0 hover:bg-muted/30">
                        ...
                        <td className="p-3"><Badge variant="outline" className="text-xs">{o.status}</Badge></td>
                  ...
                  <tbody>
                    {filteredInvoices.length === 0 ? (
                      ...
                      <tr key={i.invoice_number} className="border-b last:border-0 hover:bg-muted/30">
                        ...
                        <td className="p-3"><Badge variant="outline" className={`text-xs ${i.status === "paid" ? "text-chart-2" : i.status === "overdue" ? "text-destructive" : ""}`}>{i.status}</Badge></td>
                    ...
                    {filteredTxns.length === 0 ? (
                      ...
                      return (
                        <tr key={t.transaction_number} className="border-b last:border-0 hover:bg-muted/30">
                          ...
                          <td className="p-3"><Badge variant="outline" className={`text-xs ${isCredit ? "text-chart-2" : "text-destructive"}`}>{t.type}</Badge></td>
