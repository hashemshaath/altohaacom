...
import {
  ...
  Crown, Megaphone, AlertCircle, Info, Clock,
} from "lucide-react";
            ...
            <div className="space-y-2">
              {filtered.map(n => {
                ...
                return (
                  <Card
                    key={n.id}
                    className={`transition-all duration-200 hover:shadow-sm cursor-pointer ${!n.is_read ? "border-primary/30 bg-primary/[0.02]" : ""}`}
