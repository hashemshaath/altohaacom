            ...
            <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-3 rounded-xl bg-primary-foreground/10 backdrop-blur-sm px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-primary-foreground/70">{completionScore === 100 ? (isAr ? "مكتمل ✓" : "Complete ✓") : (isAr ? "أكمل ملفك" : "Complete it")}</p>
                </div>
              </div>
            </div>
          )}
      ...
      {opportunities.map((comp) => {
        ...
        return (
          ...
          >
            ...
            <Badge variant="outline" className="shrink-0 text-xs bg-chart-3/5 text-chart-3 border-chart-3/30">
