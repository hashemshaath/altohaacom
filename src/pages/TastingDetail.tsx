                              ...
                              <div key={e.id} className="flex items-center gap-3 py-3 group">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="flex items-center gap-2">
                                    ...
                                    {e.category && <Badge variant="outline" className="text-xs shrink-0">{e.category}</Badge>}
                                  </div>
                                  <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    {entryScores.length > 0 && (
                                      <Badge variant="secondary" className="text-xs h-4">{entryScores.length} {isAr ? "تقييم" : "scores"}</Badge>
                                    )}
                                  </div>
                                </div>
