                    ...
                    return (
                      ...
                      <Card className={`mb-3 w-28 sm:w-36 md:w-44 overflow-hidden border-border/60 bg-gradient-to-b ${config.gradient} ${isFirst ? "shadow-lg shadow-chart-4/10" : ""}`}>
                        <CardContent className="p-4 md:p-5 text-center">
                          ...
                          <div className="flex items-center justify-center gap-1.5 text-xs md:text-xs text-muted-foreground mb-2">
                          ...
                          {winner.category_name && (
                            <Badge variant="outline" className="mb-2 text-xs md:text-xs h-4 px-1.5">
                          ...
                          <Badge className={`mt-2 text-xs ${isFirst ? "bg-chart-4/10 text-chart-4 border-chart-4/20" : ""}`} variant="outline">
          ...
          {others.length > 0 && (
            <div className="max-w-2xl mx-auto">
              <h2 className="mb-4 flex items-center gap-2 text-lg font-semibold">
                ...
                <Badge variant="secondary" className="ms-1 text-xs">{others.length}</Badge>
              </h2>
