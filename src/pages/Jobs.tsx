  ...
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      const [{ count: jobCount }, { count: chefCount }, { count: companyCount }] = await Promise.all([
        ...
        supabase.from("profiles").select("id", { count: "exact", head: true }).eq("is_open_to_work", true).eq("job_availability_visibility", "public").eq("is_chef_visible", true),
    ...
    <div className="flex min-h-screen flex-col bg-background" dir={isAr ? "rtl" : "ltr"}>
      ...
      <main className="flex-1">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="rounded-2xl border-border/15 overflow-hidden group hover:shadow-2xl transition-all duration-500">
                <div className="relative h-48 overflow-hidden">
                  <img src={employerImage} alt="Employers" loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
              ...
              <Card className="rounded-2xl border-border/15 overflow-hidden group hover:shadow-2xl transition-all duration-500">
                <div className="relative h-48 overflow-hidden">
                  <img src={chefImage} alt="Chefs" loading="lazy" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                  <div className="absolute inset-0 bg-gradient-to-t from-card via-card/60 to-transparent" />
                  <div className="absolute bottom-4 start-5">
                    <div className="flex items-center gap-2.5">
        ...
        <section className="relative py-20 overflow-hidden">
          <img src={heroImage} alt="Jobs hero" loading="lazy" className="absolute inset-0 w-full h-full object-cover" />
