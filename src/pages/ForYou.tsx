            ...
            <CardContent className="p-0">
              {c.image_url && (
                <div className="h-32 overflow-hidden">
                  <img src={c.image_url} alt="" loading="lazy" className="h-full w-full object-cover transition-transform group-hover:scale-105" loading="lazy" />
                </div>
              )}
        ...
        <Link key={e.id} to={`/exhibitions/${e.slug}`} className="group">
          <Card className="overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5 border-border/40">
            <CardContent className="p-0">
              {e.image_url && (
                <div className="h-32 overflow-hidden">
                  <img src={e.image_url} alt="" loading="lazy" className="h-full w-full object-cover transition-transform group-hover:scale-105" loading="lazy" />
                </div>
              )}
              <div className="p-3 space-y-1.5">
        ...
        <Link key={r.id} to={`/recipes/${r.slug}`} className="group">
          <Card className="overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5 border-border/40">
            <CardContent className="p-0">
              {r.image_url && (
                <div className="h-32 overflow-hidden">
                  <img src={r.image_url} alt="" loading="lazy" className="h-full w-full object-cover transition-transform group-hover:scale-105" loading="lazy" />
                </div>
              )}
              <div className="p-3 space-y-1.5">
          ...
          <Card className="overflow-hidden transition-all hover:shadow-md hover:-translate-y-0.5 border-border/40">
            <CardContent className="p-0">
              {a.featured_image_url && (
                <div className="h-32 overflow-hidden">
                  <img src={a.featured_image_url} alt="" loading="lazy" className="h-full w-full object-cover transition-transform group-hover:scale-105" />
                </div>
              )}
              <div className="p-3 space-y-1.5">
