          ...
          <div className="space-y-2">
            {tab === "competitions" && competitions.map((c) => (
              <Card key={c.id} className="overflow-hidden">
                <CardContent className="p-3 flex items-center gap-3">
                  {c.cover_image_url && (
                    <img src={c.cover_image_url} alt={c.title || "Competition"} loading="lazy" className="h-12 w-12 rounded-lg object-cover shrink-0" />
                  )}
              ...
              <Card key={a.id} className="overflow-hidden">
                <CardContent className="p-3 flex items-center gap-3">
                  {a.featured_image_url && (
                    <img src={a.featured_image_url} alt={a.title || "Article"} loading="lazy" className="h-12 w-12 rounded-lg object-cover shrink-0" />
                  )}
                  <div className="min-w-0 flex-1">
            ...
            {tab === "recipes" && recipes.map((r) => (
              <Card key={r.id} className="overflow-hidden">
                <CardContent className="p-3 flex items-center gap-3">
                  {r.image_url && (
                    <img src={r.image_url} alt={r.title || "Recipe"} loading="lazy" className="h-12 w-12 rounded-lg object-cover shrink-0" />
                  )}
                  <div className="min-w-0 flex-1">
