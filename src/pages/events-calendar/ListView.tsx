      ...
      {groupedUpcoming.map(([monthKey, monthEvents]) => (
        <div key={monthKey}>
          <div className="flex items-center gap-3 mb-3">
            ...
            <Badge variant="outline" className="text-xs tabular-nums">{monthEvents.length}</Badge>
      ...
      {pastEvents.length > 0 && (
        <div>
          <div className="flex items-center gap-3 mb-3">
            ...
            <Badge variant="outline" className="text-xs tabular-nums">{pastEvents.length}</Badge>
            <div className="flex-1 h-px bg-border/30" />
          </div>
    ...
    <Card className={cn(
      ...
      <div className="flex">
        <div className={cn(
          ...
          {!countdown.past && (
            <div className={cn(
              "absolute top-1.5 end-1.5 rounded-md px-1.5 py-0.5 text-xs font-bold shadow-sm",
        ...
        <div className="flex-1 min-w-0 p-3 sm:p-4 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-1.5 flex-wrap mb-1.5">
              ...
              {event.is_recurring && (
                <Badge variant="outline" className="text-xs px-1 py-0">{isAr ? "سنوي" : "Annual"}</Badge>
              )}
